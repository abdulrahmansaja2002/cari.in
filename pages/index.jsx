...
const Home = () => {
  return (
    <div className="dark:bg-zinc-900 flex flex-col justify-center items-center w-screen h-screen">
      <div className="text-8xl">
        <span className="text-blue-500">Cari.in</span>
      </div>
      <form action="/search" method="get" className="w-5/6 m-4 flex justify-center">
        {/* <div className="w-1/2">
          <input
            type="text"
            className="h-12 rounded-full w-full  bg-transparent border-2"
            placeholder="Type your query here..."
            name="query"
          />
          <button
            type="submit"
            className="absolute -translate-x-16 translate-y-3 text-white"
          >
            Search
          </button>
